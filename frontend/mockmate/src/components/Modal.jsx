/**
 * Description:
 * A reusable modal (popup dialog) component that overlays the entire screen.
 * 
 * Props:
 *  - isOpen (boolean): controls visibility of the modal
 *  - onClose (function): handler for closing the modal
 *  - title (string): optional modal title
 *  - hideHeader (boolean): whether to hide the modal header
 *  - children (JSX): content to display inside the modal
 */
