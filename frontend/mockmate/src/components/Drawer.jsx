/**
 * Description:
 * A reusable slide-in drawer component that appears from the right side of the screen.
 * 
 * Props:
 *  - isOpen (boolean): controls the visibility of the drawer
 *  - onClose (function): handler to close the drawer
 *  - title (string): title displayed in the header
 *  - children (JSX): content to render inside the drawer
 */
