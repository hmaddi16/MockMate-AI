/**
 * Description:
 * This component renders AI-generated markdown content with rich formatting support,
 * including code blocks with syntax highlighting, lists, links, headings, and more.
 * It uses `react-markdown` with custom renderers and `react-syntax-highlighter` for styled code.
 */
...
/**
 * CodeBlock Component
 * Renders highlighted code with a copy-to-clipboard button
 */
        ...
        <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
                ...
                >
                    ...
                    {copied && (
                        <span className="absolute -top-8 right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 hover:opacity-100 transition">
                            Copied!
                        </span>
                    )}
                </button>
